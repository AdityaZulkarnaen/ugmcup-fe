  ...
  return (
    <section className="bg-white py-20 text-center text-[#0B0B0F] sm:py-28">
      <div className="mx-auto flex w-[87.5%] max-w-4xl flex-col items-center">
        <h2 className="text-3xl font-black italic leading-[1.15] sm:text-5xl lg:text-6xl">
        ...
        <p className="mt-10 max-w-lg text-xs leading-relaxed text-[#3A3A42] sm:text-sm">
        ...
        <p className="mt-6 max-w-lg text-xs font-bold text-[#0B0B0F] sm:text-sm">
